...
$(function(){
    clickaShowWindow(".addressdialog",".address ul li.last");
$(".fullBg").click(function(){
    ...
    var starIcon=$(".ratingWindow .ratingBox i");
    starIcon.bind('click',function(){
        starIcon.removeClass('on');
        var iCount=starIcon.index(this)+1;
        for(var i=0;i<iCount;i++){
            starIcon.eq(i).addClass('on');
        }
    });
});
...
$(function(){
    ...
    //评价弹窗推荐菜状态切换
    $(".ratingForm .row .moreList span").click(function(){
        $(this).toggleClass("on");
    });
});
